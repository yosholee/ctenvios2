...
import { termsLanguage, type TermsLanguage } from "@/content/terms";

function formatPrivacyDate(isoDate: string, language: TermsLanguage): string {
...
export function PrivacyClient(): ReactElement {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 lg:px-8 lg:py-20">
      ...
      <p className="mt-4 text-sm text-brand-navy/60">
        ...
        {formatPrivacyDate(privacy.lastUpdated, language)}
      </p>
